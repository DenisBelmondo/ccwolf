...
ccwolf (Cookies & Cream Wolfenstein) is a source port based on [Ioan Chera's
SDL2 port of Wolf4SDL](https://bitbucket.org/ichera/wolf4sdl/branch/sdl2). The
purpose of this port is to bring the vanilla Wolfenstein 3D experience to modern
platforms in a similar way Chocolate Doom did for that game. ccwolf is currently
under development and is thus unstable. All code related to Dreamcast and GP2X
was pruned.
...
- Fork that enables scripting support.
- PC speaker sounds.
