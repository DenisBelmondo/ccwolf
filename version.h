...
//#define USE_FLOORCEILINGTEX // Enables floor and ceiling textures stored in the third mapplane (see
//wl_floorceiling.cpp) #define USE_HIRES           // Enables high resolution textures/sprites (128x128) #define
//USE_PARALLAX 16     // Enables parallax sky with 16 textures per sky (see wl_parallax.cpp) #define USE_CLOUDSKY //
//Enables cloud sky support (see wl_cloudsky.cpp) #define USE_STARSKY         // Enables star sky support (see
//wl_atmos.cpp) #define USE_RAIN            // Enables rain support (see wl_atmos.cpp) #define USE_SNOW            //
//Enables snow support (see wl_atmos.cpp) #define FIXRAINSNOWLEAKS    // Enables leaking ceilings fix (by Adam Biser,
//only needed if maps with rain/snow and ceilings exist)
